...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $verify_link = BASE_URL.'http://semarinom.online/verify.php?email= '.$to.'&token='.$token;
        $message = '
    '.LANG_VALUE_151.'<br><br>

        <a href="'.$verify_link.'">'.$verify_link.'</a>';

        $headers = "From: noreply@example.com" . BASE_URL . "\r\n" .
                   "Reply-To: noreply@example.com" . BASE_URL . "\r\n" .
